...
#' @param output_dir Character, output directory for downloaded files, default "./"
...
#'
#' @export
download_receptor <- function(pdb_ids, output_dir = "./", verify_ssl = TRUE) {
  ...
  download_one <- function(pdb_id) {
    ...
    dest <- file.path(output_dir, paste0(pdb_id, ".pdb"))
...
#' @param output_dir Character, output directory for downloaded files, default "ligands"
#' @param verify_ssl Logical, whether to verify SSL certificates, default TRUE
#'
#' @return List of successfully downloaded file paths
#' @import httr
...
#'
#' @export
download_ligand <- function(cids, output_dir = "ligands", verify_ssl = TRUE) {
  ...
  download_one <- function(cid) {
    ...
    dest <- file.path(output_dir, paste0(cid, ".sdf"))
